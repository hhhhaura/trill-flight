...
WINDOW_SIZE = int(SAMPLE_RATE * 0.5)  # Buffer size for each audio frame (0.5 seconds)
...
PERIODICITY_THRESH = 0.01  # Maximum standard deviation for peak intervals to be periodic
